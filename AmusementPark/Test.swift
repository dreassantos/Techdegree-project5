...
//            _ = try SeniorGuest(firstName: "jan", lastName: "jan", dateOfBirth: birthDate)
//        } catch let error {
//            print(error.localizedDescription)
//        }
//
...
//            _ = try  SeniorGuest(firstName: "Carlos", lastName: "Santiago", dateOfBirth: birthDate)
//        } catch let error {
//            print(error.localizedDescription)
//        }
//    }
...
//
//        do{//Nothing missing
//            _ = try FoodServicesEmployee(firstname: "frank", lastName: "Smith", streetAddress: "123 Street", city: "SM", state: "CA ", zipCode: "12345")
//        } catch let error {
//            print(error.localizedDescription)
//        }
//
//        do{//missing firstName
//            _ = try RideServicesEmployee(firstname: " ", lastName: "Kale", streetAddress: "123 Street", city: "SM", state: "CA", zipCode: "12345")
//        } catch let error {
//            print(error.localizedDescription)
//        }
//
//        do{//missing city
//            _ = try Manager(firstname: "Diana", lastName: "Cruz ", streetAddress: "123 Street", city: " ", state: "CA", zipCode: "12345")
//        } catch let error {
//            print(error.localizedDescription)
//        }
//    }
